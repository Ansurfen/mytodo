...
class DarkTheme extends AppTheme {
  DarkTheme({
    ...
    TextStyle super.incomingChatLinkTitleStyle = const TextStyle(
      color: Colors.black,
    ),
    TextStyle super.outgoingChatLinkTitleStyle = const TextStyle(
      color: Colors.white,
    ),
    TextStyle super.outgoingChatLinkBodyStyle = const TextStyle(
      color: Colors.white,
    ),
    TextStyle super.incomingChatLinkBodyStyle = const TextStyle(
      color: Colors.white,
    ),
  ...
  }) : super(recordIconColor: recorderIconColor);
}
