            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  ...
                  const SizedBox(height: 5),
                  BubbleTextFormField(maxLines: 1, hintText: "cron".tr),
                  const SizedBox(height: 10),
                    ...
                    children: [
                      ...
                      Expanded(
                        child: BubbleDropdown(
                          ...
                          child:
                              controller.arrivalController.text.isNotEmpty
                                  ? Text(
                                    DateFormat('yyyy/MM/dd HH:mm:ss').format(
                                      DateTime.parse(
                  ...
                  Padding(
                    ...
                    child: Column(children: conditionsList()),
                  ),
                  Obx(
                    () =>
                        controller.activeLocale.value
                            ? Obx(
                              () => Column(
                                children: [
                                  distanceViewUI(
                  ...
                  Obx(
                    () =>
                        controller.activeFileUpload.value
                            ? BubbleTextFormField(
                              maxLines: 1,
                  ...
                  Obx(
                    () =>
                        controller.activeContent.value
