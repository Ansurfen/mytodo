...
import 'package:my_todo/view/add/slider_view.dart';

Widget distanceViewUI(
    BuildContext context, double distValue, void Function() onTap) {
  return Column(
...
Widget contentLimit(BuildContext context) {
  RangeValues values = const RangeValues(200, 600);
  return Column(
    mainAxisAlignment: MainAxisAlignment.center,
    crossAxisAlignment: CrossAxisAlignment.start,
    children: [
