...
class _TopicPageState extends State<TopicPage> {
  ...
  Widget build(BuildContext context) {
    ...
    controller.event.add(TimelineEventDisplay(
        ...
        appBar: todoAppBar(
          ...
          actions: [
            ...
            IconButton(
                onPressed: () async {
                  TodoShare.shareUri(
                      context, Uri.parse(controller.model.inviteCode));
                },
  ...
  TimelineEventDisplay get yearEvent {
    return TimelineEventDisplay(
        ...
        indicatorSize: 15,
        indicator: timePoint(15, Colors.white,
            borderColor: Theme.of(context).primaryColor, borderWidth: 2));
  }

  Widget get randomTimePoint {
    var style = TimePointPainter.random();
    return timePoint(style.size, style.fillColor,
  ...
  Widget timePoint(double size, Color fillColor,
...
class TimePointStyle {
  ...
  TimePointStyle(this.size, this.fillColor,
...
class TimePointPainter {
  ...
  static init(BuildContext context) {
    _style = [
      TimePointStyle(12, Colors.white,
      ...
      TimePointStyle(15, Colors.white,
          borderColor: Theme.of(context).primaryColor, borderWidth: 2),
    ];
  }
