                              ...
                              child: SizedBox(
                                  ...
                                  child: Obx(() => taskForms((form) {
                                        ...
                                        switch (form.type.index) {
                                          ...
                                          case 6:
                                            taskHasPerm(TaskHasPermRequest(
                                                    tid: controller.id))
                                                .then((res) {
                                              if (res.has) {
      ...
      children: [
        SizedBox(
          ...
          child: Container(
            decoration: BoxDecoration(
              ...
              border:
                  Border.all(color: const Color(0xFF3A5160).withOpacity(0.2)),
            ),
            child: Icon(
              Icons.sort,
              color: ThemeProvider.style.normal(),
        ...
        Obx(() => LightButton(
              onTap: () {
                ...
                } else if (controller.selectedTask.type ==
